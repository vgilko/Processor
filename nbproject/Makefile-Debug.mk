...
${OBJECTDIR}/DconSender.o: DconSender.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DconSender.o DconSender.cpp

${OBJECTDIR}/PanelSender.o: PanelSender.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PanelSender.o PanelSender.cpp

${OBJECTDIR}/Processor.o: Processor.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Processor.o Processor.cpp

${OBJECTDIR}/SerialSender.o: SerialSender.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SerialSender.o SerialSender.cpp

${OBJECTDIR}/SocketReceiver.o: SocketReceiver.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SocketReceiver.o SocketReceiver.cpp

${OBJECTDIR}/SocketSender.o: SocketSender.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SocketSender.o SocketSender.cpp

${OBJECTDIR}/module_new.o: module_new.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/modbus -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/module_new.o module_new.cpp
